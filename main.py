...
def attack(char_name: str, char_class: str) -> str:
    ...
    Генерирует количество очков атаки в зависимости от
    выбранного типа персонажа и возвращает строковое
...
def defence(char_name: str, char_class: str) -> str:
    ...
    Генерирует количество очков защиты в зависимости от
    выбранного типа персонажа и возвращает строковое сообщение
...
def start_training(char_name: str, char_class: str) -> str:
    """Запусти цикл тренировки навыков персонажа.
...
if __name__ == '__main__':
    ...
    Она запускает игру,
    и из неё вызываются все вспомогательные функции.
    """
    run_screensaver()
